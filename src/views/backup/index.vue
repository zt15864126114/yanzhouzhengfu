...
const originalBackupList = ref<BackupItem[]>([
  ...
  { id: 4, name: '配置文件备份', owner: '孙丽', type: 'full', source: '/etc', target: '/backup/config', schedule: 'daily', status: 'waiting', progress: 0, lastRunTime: '2025-05-20 02:00', desc: '系统配置文件每日全量备份' },
  { id: 5, name: '日志文件备份', owner: '周伟', type: 'incremental', source: '/var/log', target: '/backup/logs', schedule: 'weekly', status: 'completed', progress: 100, lastRunTime: '2025-05-20 03:00', desc: '日志文件每周增量备份' }
])
